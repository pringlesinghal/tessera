# configs/ssl_config_2gpu.py
# Configuration for 2 GPU testing before scaling to 8 GPUs
# Effective batch size: 256 * 2 * 8 = 4,096
...
config = {
    ...
    "sample_size_s2": 40,
    "sample_size_s1": 40,
    "num_workers": 1,  # Conservative for testing
    "shuffle_tiles": True,
    
    # ========== Logging and Validation ==========
    "log_interval_steps": 5,  # More frequent logging for testing
    ...
    # ========== Wandb Configuration ==========
    "wandb_project": "tessera-ssl-fsdp-2gpu-test",  # Separate project for 2 GPU tests
    "wandb_api_key": "",
