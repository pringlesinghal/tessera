# configs/ssl_config_2gpu_debug.py
# Debug configuration for 2 GPU testing - minimal accumulation for faster debugging
# Effective batch size: 256 * 2 * 2 = 1,024
...
config = {
    ...
    "years": [2016, 2017],  # Only 2 years for faster iteration
    "cache_size": 20,  # Small cache for debug
    
    # ========== Training Parameters - DEBUG ==========
    "batch_size": 256,  # Per GPU batch size
    "gradient_accumulation_steps": 2,  # MINIMAL for debugging (256 * 2 * 2 = 1,024)
    ...
    "log_interval_steps": 1,  # Log EVERY step for debugging
    "val_interval_steps": 0,  # Disable validation for debug
    "eval_method": "linear_probe",
    # Validation data paths (not used since val disabled)
    ...
    "apply_qat_representation": False,  # Disable for simpler debug
    ...
    # ========== Wandb Configuration ==========
    "wandb_project": "tessera-ssl-fsdp-2gpu-debug",
    "wandb_api_key": "",
