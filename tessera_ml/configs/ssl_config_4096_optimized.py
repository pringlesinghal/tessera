# configs/ssl_config_4096_optimized.py
# Optimized configuration with batch size 4096 and post-normalization
# Based on optimization findings: no workers, larger cache, post-normalization

config = {
    # ========== TreeDataset Configuration (OPTIMIZED) ==========
    ...
    "cache_size": 2000,  # Optimized cache size for all years
    
    # ========== Training Parameters (OPTIMIZED) ==========
    "batch_size": 4096,  # Large batch size as requested
    "epochs": 1,
    "learning_rate": 0.002,
    "barlow_lambda": 5e-3,
    "warmup_ratio": 0.1,
    ...
    "apply_amp": True,  # Mixed precision for memory efficiency
    ...
    # ========== Wandb Configuration ==========
    "wandb_project": "tessera-ssl-optimized-4096",
    "wandb_api_key": "",
